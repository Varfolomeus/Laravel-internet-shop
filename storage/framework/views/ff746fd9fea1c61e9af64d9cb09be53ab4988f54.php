<?php if($paginator->hasPages()): ?>
    <nav>
        <ul class="pagination">
            ...
            <?php else: ?>
                <li class="page-item">
                    <a class="page-link" href="<?php echo e(\Request::url()); ?>" rel="prev"
                        aria-label="<?php echo app('translator')->get('pagination.first'); ?>">&laquo;</a>
                </li>
            <?php endif; ?>
            ...
            <?php if($paginator->hasMorePages()): ?>
                <li class="page-item">
                    <a class="page-link" href="<?php echo e(\Request::url() . '?page=' . $paginator->lastPage()); ?>" rel="last"
                        aria-label="<?php echo app('translator')->get('pagination.last'); ?>">&raquo;</a>
                </li>
            <?php else: ?>
...
<?php endif; ?>
<?php /**PATH D:\games\Laravel\foxtrot\resources\views/vendor/pagination/bootstrap-4.blade.php ENDPATH**/ ?>